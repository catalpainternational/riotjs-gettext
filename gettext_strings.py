...
npgettext_lazy("""bar""", """There is one activity""", """There are many activities""", 1)
npgettext_lazy("""foo""", """There is one activity""", """There are many activities""", 1)
...
pgettext_lazy("""editor""", """A detailed description of the %s objectives and its expected outcomes.""")
pgettext_lazy("""editor""", """Collaboration Type""")
pgettext_lazy("""editor""", """Details of groups that are intended to benefit from the %s.""")
...
pgettext_lazy("""editor""", """This explains what the %s is, it’s longer than the title and contains more detail.""")
